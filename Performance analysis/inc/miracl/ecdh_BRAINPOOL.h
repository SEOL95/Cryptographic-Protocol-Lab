...
#ifndef ECDH_BRAINPOOL_H
#define ECDH_BRAINPOOL_H
...
//#define EAS_BRAINPOOL 16 /**< Symmetric Key size - 128 bits */
//#define HASH_TYPE_ECC_BRAINPOOL SHA512  /**< Hash type */

/*** END OF USER CONFIGURABLE SECTION ***/

#define EGS_BRAINPOOL MODBYTES_256_56  /**< ECC Group Size in bytes */
#define EFS_BRAINPOOL MODBYTES_256_56  /**< ECC Field Size in bytes */
...
*/
extern void RFC7748_BRAINPOOL(BIG_256_56 r);
...
*/
extern int ECP_BRAINPOOL_IN_RANGE(octet *s);
 ...
 */
extern int  ECP_BRAINPOOL_KEY_PAIR_GENERATE(csprng *R, octet *s, octet *W);
 ...
 */
extern int  ECP_BRAINPOOL_PUBLIC_KEY_VALIDATE(octet *W);
 ...
 *
	...
	@return 0 or an error code
 */
extern int ECP_BRAINPOOL_SVDP_DH(octet *s, octet *W, octet *K, int type);
 ...
 */
extern void ECP_BRAINPOOL_ECIES_ENCRYPT(int h, octet *P1, octet *P2, csprng *R, octet *W, octet *M, int len, octet *V, octet *C, octet *T);
 ...
 */
extern int ECP_BRAINPOOL_ECIES_DECRYPT(int h, octet *P1, octet *P2, octet *V, octet *C, octet *T, octet *U, octet *M);
 ...
 */
extern int ECP_BRAINPOOL_SP_DSA(int h, csprng *R, octet *k, octet *s, octet *M, octet *c, octet *d);
 ...
 *
	...
	@return 0 or an error code
 */
extern int ECP_BRAINPOOL_VP_DSA(int h, octet *W, octet *M, octet *c, octet *d);
/*#endif*/
