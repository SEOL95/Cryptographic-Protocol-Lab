...
#define CURVETYPE_ANSSI WEIERSTRASS          /**< Define Curve Type */
#define CURVE_A_ANSSI -3            /**< Curve A parameter */
#define PAIRING_FRIENDLY_ANSSI NOT_PF   /**< Is curve pairing-friendly */
#define CURVE_SECURITY_ANSSI 128     /**< Curve security level in AES bits */
#define HTC_ISO_ANSSI 0            /**< Use Isogenies for Hash to Curve */
...
#define HTC_ISO_G2_ANSSI 0        /**< Use Isogenies for G2 Hash to Curve */
...
#define USE_GS_GT_ANSSI /**< Not patented, so probably OK to always use this */

#define POSITIVEX 0
#define NEGATIVEX 1

#define SEXTIC_TWIST_ANSSI        /**< Sextic Twist M or D type */
#define SIGN_OF_X_ANSSI           /**< Sign of curve parameter */ 

#define ATE_BITS_ANSSI            /**< Number of Bits in curve parameter */
#define G2_TABLE_ANSSI            /**< Size of table for pairing precomputation for fixed G2 */
