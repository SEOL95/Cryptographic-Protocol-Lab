...
#ifndef HPKE_BRAINPOOL_H
#define HPKE_BRAINPOOL_H
 ...
 */
extern int DeriveKeyPair_BRAINPOOL(int config_id,octet *SK,octet *PK,octet *SEED);
 ...
 */
extern void HPKE_BRAINPOOL_Encap(int config_id,octet *SK,octet *Z,octet *pkE,octet *pkR);
 ...
 */
extern void HPKE_BRAINPOOL_Decap(int config_id,octet *skR,octet *Z,octet *pkE,octet *pkR);
 ...
 */
extern void HPKE_BRAINPOOL_AuthEncap(int config_id,octet *skE,octet *skS,octet *Z,octet *pkE,octet *pkR,octet *pkS);
 ...
 *
    ...
    @param pkS the Initiators public key
 */
extern void HPKE_BRAINPOOL_AuthDecap(int config_id,octet *skR,octet *Z,octet *pkE,octet *pkR,octet *pkS);
 ...
 */
extern void HPKE_BRAINPOOL_KeySchedule(int config_id,octet *key,octet *nonce,octet *exp_secret,int mode,octet *Z,octet *info,octet *psk,octet *pskID);
