...
#define CURVETYPE_HIFIVE EDWARDS          /**< Define Curve Type */
#define CURVE_A_HIFIVE 1            /**< Curve A parameter */
#define PAIRING_FRIENDLY_HIFIVE NOT_PF   /**< Is curve pairing-friendly */
#define CURVE_SECURITY_HIFIVE 192     /**< Curve security level in AES bits */
#define HTC_ISO_HIFIVE 0            /**< Use Isogenies for Hash to Curve */

// Permit alternate compression method if 3 spare top bits in field representation
// Must be set manually
//#define ALLOW_ALT_COMPRESS_HIFIVE

#if PAIRING_FRIENDLY_HIFIVE != NOT_PF

#define HTC_ISO_G2_HIFIVE 0        /**< Use Isogenies for G2 Hash to Curve */
...
#define USE_GS_GT_HIFIVE /**< Not patented, so probably OK to always use this */

#define POSITIVEX 0
#define NEGATIVEX 1

#define SEXTIC_TWIST_HIFIVE        /**< Sextic Twist M or D type */
#define SIGN_OF_X_HIFIVE           /**< Sign of curve parameter */ 

#define ATE_BITS_HIFIVE            /**< Number of Bits in curve parameter */
#define G2_TABLE_HIFIVE            /**< Size of table for pairing precomputation for fixed G2 */
