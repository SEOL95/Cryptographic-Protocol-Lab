...
#define CURVETYPE_BRAINPOOL WEIERSTRASS          /**< Define Curve Type */
#define CURVE_A_BRAINPOOL -3            /**< Curve A parameter */
#define PAIRING_FRIENDLY_BRAINPOOL NOT_PF   /**< Is curve pairing-friendly */
#define CURVE_SECURITY_BRAINPOOL 128     /**< Curve security level in AES bits */
#define HTC_ISO_BRAINPOOL 0            /**< Use Isogenies for Hash to Curve */

// Permit alternate compression method if 3 spare top bits in field representation
// Must be set manually
//#define ALLOW_ALT_COMPRESS_BRAINPOOL

#if PAIRING_FRIENDLY_BRAINPOOL != NOT_PF

#define HTC_ISO_G2_BRAINPOOL 0        /**< Use Isogenies for G2 Hash to Curve */
...
#define USE_GS_GT_BRAINPOOL /**< Not patented, so probably OK to always use this */

#define POSITIVEX 0
#define NEGATIVEX 1

#define SEXTIC_TWIST_BRAINPOOL        /**< Sextic Twist M or D type */
#define SIGN_OF_X_BRAINPOOL           /**< Sign of curve parameter */ 

#define ATE_BITS_BRAINPOOL            /**< Number of Bits in curve parameter */
#define G2_TABLE_BRAINPOOL            /**< Size of table for pairing precomputation for fixed G2 */
