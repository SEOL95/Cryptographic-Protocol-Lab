...
#ifndef ECDH_SECP256K1_H
#define ECDH_SECP256K1_H
...
//#define EAS_SECP256K1 16 /**< Symmetric Key size - 128 bits */
//#define HASH_TYPE_ECC_SECP256K1 SHA512  /**< Hash type */

/*** END OF USER CONFIGURABLE SECTION ***/

#define EGS_SECP256K1 MODBYTES_256_56  /**< ECC Group Size in bytes */
#define EFS_SECP256K1 MODBYTES_256_56  /**< ECC Field Size in bytes */
...
*/
extern void RFC7748_SECP256K1(BIG_256_56 r);
...
*/
extern int ECP_SECP256K1_IN_RANGE(octet *s);
 ...
 *
	...
	@return 0 or an error code
 */
extern int ECP_SECP256K1_SVDP_DH(octet *s, octet *W, octet *K, int type);
 ...
 */
extern void ECP_SECP256K1_ECIES_ENCRYPT(int h, octet *P1, octet *P2, csprng *R, octet *W, octet *M, int len, octet *V, octet *C, octet *T);
 ...
 */
extern int ECP_SECP256K1_ECIES_DECRYPT(int h, octet *P1, octet *P2, octet *V, octet *C, octet *T, octet *U, octet *M);
 ...
 */
extern int ECP_SECP256K1_SP_DSA(int h, csprng *R, octet *k, octet *s, octet *M, octet *c, octet *d);
 ...
 *
	...
	@return 0 or an error code
 */
extern int ECP_SECP256K1_VP_DSA(int h, octet *W, octet *M, octet *c, octet *d);
/*#endif*/
