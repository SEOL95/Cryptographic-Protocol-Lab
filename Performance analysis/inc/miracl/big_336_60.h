...
#define BIGBITS_336_60 (8*MODBYTES_336_60) /**< Length in bits */
#define NLEN_336_60 (1+((8*MODBYTES_336_60-1)/BASEBITS_336_60)) /**< length in bytes */
#define DNLEN_336_60 2*NLEN_336_60 /**< Double length in bytes */
#define BMASK_336_60 (((chunk)1<<BASEBITS_336_60)-1) /**< Mask = 2^BASEBITS-1 */
#define NEXCESS_336_60 (1<<(CHUNK-BASEBITS_336_60-1))           /**< 2^(CHUNK-BASEBITS-1) - digit cannot be multiplied by more than this before normalisation */

#define HBITS_336_60 (BASEBITS_336_60/2)      /**< Number of bits in number base divided by 2 */
#define HMASK_336_60 (((chunk)1<<HBITS_336_60)-1)    /**< Mask = 2^HBITS-1 */

//#define DEBUG_NORM

#ifdef DEBUG_NORM  /* Add an extra location to track chunk extension */
#define MPV_336_60 NLEN_336_60
#define MNV_336_60 (NLEN_336_60+1)
typedef chunk BIG_336_60[NLEN_336_60 + 2]; /**< Define type BIG as array of chunks */
#define DMPV_336_60 DNLEN_336_60
#define DMNV_336_60 (DNLEN_336_60+1)
typedef chunk DBIG_336_60[DNLEN_336_60 + 2]; /**< Define type DBIG as array of chunks */
#else
typedef chunk BIG_336_60[NLEN_336_60];     /**< Define type BIG as array of chunks */
typedef chunk DBIG_336_60[DNLEN_336_60];   /**< Define type DBIG as array of chunks */
#endif
 ...
 *
    ...
    @return ignore
 */
extern chunk BIG_336_60_cswap(BIG_336_60 x, BIG_336_60 y, int s);
 ...
 *
    ...
    @return ignore
 */
extern chunk BIG_336_60_cmove(BIG_336_60 x, BIG_336_60 y, int s);
 ...
 *
    ...
    @return ignore
 */
extern chunk BIG_336_60_dcmove(BIG_336_60 x, BIG_336_60 y, int s);
/**	@brief Convert from BIG number to byte array (Constant Time)
 *
	@param a byte array
	@param x BIG number
 */
extern void BIG_336_60_toBytes(char *a, BIG_336_60 x);
/**	@brief Convert to BIG number from byte array (Constant Time)
 *
	@param x BIG number
	@param a byte array
 */
extern void BIG_336_60_fromBytes(BIG_336_60 x, char *a);
 ...
 */
extern void BIG_336_60_fromBytesLen(BIG_336_60 x, char *a, int s);
 ...
 *
   ...
   @param s byte array length
 */
extern void BIG_336_60_dfromBytesLen(DBIG_336_60 x, char *a, int s);
/**	@brief Outputs a DBIG number to the console (Variable Time)
 *
	@param x a DBIG number
 */
extern void BIG_336_60_doutput(DBIG_336_60 x);

/**	@brief Outputs a DBIG number to the console (Variable Time)
 *
	@param x a DBIG number
 */
extern void BIG_336_60_drawoutput(DBIG_336_60 x);
 ...
 *
	...
	@param z BIG number
 */
extern void BIG_336_60_add(BIG_336_60 x, BIG_336_60 y, BIG_336_60 z);
 ...
 *
	...
	@param z BIG number
 */
extern void BIG_336_60_or(BIG_336_60 x, BIG_336_60 y, BIG_336_60 z);
 ...
 *
	...
	@param i integer
 */
extern void BIG_336_60_inc(BIG_336_60 x, int i);
 ...
 *
	...
	@param z BIG number
 */
extern void BIG_336_60_sub(BIG_336_60 x, BIG_336_60 y, BIG_336_60 z);
/**	@brief Decrement BIG by a small integer - output not normalised (Constant Time)
 *
	@param x BIG number to be decremented
	@param i integer
 */
extern void BIG_336_60_dec(BIG_336_60 x, int i);
 ...
 *
	...
	@param z DBIG number
 */
extern void BIG_336_60_dadd(DBIG_336_60 x, DBIG_336_60 y, DBIG_336_60 z);
 ...
 *
	...
	@param z DBIG number
 */
extern void BIG_336_60_dsub(DBIG_336_60 x, DBIG_336_60 y, DBIG_336_60 z);
 ...
 */
extern void BIG_336_60_imul(BIG_336_60 x, BIG_336_60 y, int i);
 ...
 */
extern chunk BIG_336_60_pmul(BIG_336_60 x, BIG_336_60 y, int i);
/**	@brief Divide BIG by 3 - output normalised (Constant Time)
 *
	@param x BIG number
	@return Remainder
 */
extern int BIG_336_60_div3(BIG_336_60 x);
 ...
 *
	...
	@param i small integer
 */
extern void BIG_336_60_pxmul(DBIG_336_60 x, BIG_336_60 y, int i);
 ...
 *
	...
	@param z BIG number
 */
extern void BIG_336_60_mul(DBIG_336_60 x, BIG_336_60 y, BIG_336_60 z);
 ...
 *
	...
	@param z BIG number
 */
extern void BIG_336_60_smul(BIG_336_60 x, BIG_336_60 y, BIG_336_60 z);
 ...
 */
extern void BIG_336_60_sqr(DBIG_336_60 x, BIG_336_60 y);
 ...
 */
extern void BIG_336_60_monty(BIG_336_60 a, BIG_336_60 md, chunk MC, DBIG_336_60 d);
 ...
 */
extern void BIG_336_60_shl(BIG_336_60 x, int s);
 ...
 */
extern int BIG_336_60_fshl(BIG_336_60 x, int s);
 ...
 *
	...
	@return sign of r
 */
extern int BIG_336_60_ssn(BIG_336_60 r, BIG_336_60 a, BIG_336_60 m);
 ...
 */
extern chunk BIG_336_60_split(BIG_336_60 x, BIG_336_60 y, DBIG_336_60 z, int s);
 ...
 */
extern chunk BIG_336_60_norm(BIG_336_60 x);
 ...
 */
extern void BIG_336_60_dnorm(DBIG_336_60 x);
 ...
 */
extern int BIG_336_60_comp(BIG_336_60 x, BIG_336_60 y);
 ...
 */
extern void BIG_336_60_ctmod(BIG_336_60 x, BIG_336_60 n, int bd);
 ...
 */
extern void BIG_336_60_ctdmod(BIG_336_60 x, DBIG_336_60 y, BIG_336_60 n, int bd);
 ...
 *
    ...
    @param bd non-negative bit difference between maximum x and n
 */
extern void BIG_336_60_ctsdiv(BIG_336_60 x,BIG_336_60 n,int bd);
 ...
 *
    ...
    @param bd non-negative bit difference between maximum y and n
 */
extern void BIG_336_60_ctddiv(BIG_336_60 x, DBIG_336_60 y, BIG_336_60 n,int bd);
 ...
 *
	...
	@param n The modulus
 */
extern void BIG_336_60_mod(BIG_336_60 x, BIG_336_60 n); 
 ...
 *
	...
	@param n The Divisor
 */
extern void BIG_336_60_sdiv(BIG_336_60 x, BIG_336_60 n);
 ...
 *
	...
	@param n Modulus
 */
extern void BIG_336_60_dmod(BIG_336_60 x, DBIG_336_60 y, BIG_336_60 n);
 ...
 *
	...
	@param n Modulus
 */
extern void BIG_336_60_ddiv(BIG_336_60 x, DBIG_336_60 y, BIG_336_60 n);
/**	@brief  return parity of BIG, that is the least significant bit (Constant Time)
 *
	@param x BIG number
	@return 0 or 1
 */
extern int BIG_336_60_parity(BIG_336_60 x);
 ...
 *
	...
	@return 0 or 1
 */
extern int BIG_336_60_bit(BIG_336_60 x, int i);
 ...
 */
extern int BIG_336_60_lastbits(BIG_336_60 x, int n);
 ...
 */
extern void BIG_336_60_random(BIG_336_60 x, csprng *r);
 ...
 *
	...
	@param r A pointer to a Cryptographically Secure Random Number Generator
 */
extern void BIG_336_60_randomnum(BIG_336_60 x, BIG_336_60 n, csprng *r);
 ...
 *
	...
	@param r A pointer to a Cryptographically Secure Random Number Generator
 */
extern void BIG_336_60_randtrunc(BIG_336_60 x, BIG_336_60 n, int t, csprng *r);
 ...
 */
extern void BIG_336_60_modmul(BIG_336_60 x, BIG_336_60 y, BIG_336_60 z, BIG_336_60 n);
/**	@brief  Calculate x=y/z mod n (Variable Time)
 *
	...
	@param n The BIG Modulus
 */
extern void BIG_336_60_moddiv(BIG_336_60 x, BIG_336_60 y, BIG_336_60 z, BIG_336_60 n);
 ...
 *
	...
	@param n The BIG Modulus
 */
extern void BIG_336_60_modsqr(BIG_336_60 x, BIG_336_60 y, BIG_336_60 n);
 ...
 *
	...
	@param n The BIG Modulus
 */
extern void BIG_336_60_modneg(BIG_336_60 x, BIG_336_60 y, BIG_336_60 n);
 ...
 *
	...
	@param n The BIG Modulus
 */
extern void BIG_336_60_modadd(BIG_336_60 x, BIG_336_60 y, BIG_336_60 z, BIG_336_60 n);
 ...
 */
extern int BIG_336_60_jacobi(BIG_336_60 x, BIG_336_60 y);
 ...
 *
	...
	@param n The BIG Modulus
 */
extern void BIG_336_60_invmodp(BIG_336_60 x, BIG_336_60 y, BIG_336_60 n);
...
*/
extern void BIG_336_60_mod2m(BIG_336_60 x, int m);
...
static inline chunk muladd_336_60(chunk x, chunk y, chunk c, chunk *r)
{
    dchunk prod = (dchunk)x * y + c + *r;
    *r = (chunk)prod & BMASK_336_60;
    return (chunk)(prod >> BASEBITS_336_60);
}
