...
#define CURVETYPE_C25519 MONTGOMERY          /**< Define Curve Type */
#define CURVE_A_C25519 486662            /**< Curve A parameter */
#define PAIRING_FRIENDLY_C25519 NOT_PF   /**< Is curve pairing-friendly */
#define CURVE_SECURITY_C25519 128     /**< Curve security level in AES bits */
#define HTC_ISO_C25519 0            /**< Use Isogenies for Hash to Curve */
...
#define HTC_ISO_G2_C25519 0        /**< Use Isogenies for G2 Hash to Curve */
...
#define USE_GS_GT_C25519 /**< Not patented, so probably OK to always use this */

#define POSITIVEX 0
#define NEGATIVEX 1

#define SEXTIC_TWIST_C25519        /**< Sextic Twist M or D type */
#define SIGN_OF_X_C25519           /**< Sign of curve parameter */ 

#define ATE_BITS_C25519            /**< Number of Bits in curve parameter */
#define G2_TABLE_C25519            /**< Size of table for pairing precomputation for fixed G2 */
