...
#ifndef ECDH_NIST256_H
#define ECDH_NIST256_H
...
//#define EAS_NIST256 16 /**< Symmetric Key size - 128 bits */
//#define HASH_TYPE_ECC_NIST256 SHA512  /**< Hash type */

/*** END OF USER CONFIGURABLE SECTION ***/

#define EGS_NIST256 MODBYTES_256_56  /**< ECC Group Size in bytes */
#define EFS_NIST256 MODBYTES_256_56  /**< ECC Field Size in bytes */
...
*/
extern void RFC7748_NIST256(BIG_256_56 r);
...
*/
extern int ECP_NIST256_IN_RANGE(octet *s);
 ...
 */
extern int  ECP_NIST256_KEY_PAIR_GENERATE(csprng *R, octet *s, octet *W);
 ...
 */
extern int  ECP_NIST256_PUBLIC_KEY_VALIDATE(octet *W);
 ...
 *
	...
	@return 0 or an error code
 */
extern int ECP_NIST256_SVDP_DH(octet *s, octet *W, octet *K, int type);
 ...
 */
extern void ECP_NIST256_ECIES_ENCRYPT(int h, octet *P1, octet *P2, csprng *R, octet *W, octet *M, int len, octet *V, octet *C, octet *T);
 ...
 */
extern int ECP_NIST256_ECIES_DECRYPT(int h, octet *P1, octet *P2, octet *V, octet *C, octet *T, octet *U, octet *M);
 ...
 */
extern int ECP_NIST256_SP_DSA(int h, csprng *R, octet *k, octet *s, octet *M, octet *c, octet *d);
 ...
 *
	...
	@return 0 or an error code
 */
extern int ECP_NIST256_VP_DSA(int h, octet *W, octet *M, octet *c, octet *d);
/*#endif*/
